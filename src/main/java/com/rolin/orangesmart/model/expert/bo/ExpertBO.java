package com.rolin.orangesmart.model.expert.bo;
...
public class ExpertBO {
  ...
  public Expert toEntity() {
    Expert expert = BeanUtil.copyProperties(this, Expert.class);
    expert.setProducts(String.join(",", products));
    expert.setCertification(String.join(",", certification));
    return expert;
  }
}
